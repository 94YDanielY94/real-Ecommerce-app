...
export default function Footer() {
  ...
  return (
    <footer className="mt-10">
      {/* Rounded Container Outer Box */}
      <div className="mx-auto border-t-2 bg-white p-12 px-4 sm:px-6 lg:px-18">
        {/* Top Section */}
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-neutral-500">
              real. empowers creators and shoppers to discover authentic,
              high-quality products — making modern living simpler, clearer, and
              effortless to enjoy.
            </p>
        ...
        {/* Bottom Section */}
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row text-xs text-neutral-500">
          <p>© {currentYear} real. All rights reserved.</p>
